//gle: The openGL environment.
//depth: The resolution.
...
function Sphere(gle, depth, centre, radius, colourStart, colourStop, colourAmbient, colourDiffuse, colourSpecular) {
  this.gle = gle;
  this.centre = centre;
  this.buffers = {};
  this.radius = radius;
  ...
  this.colour_start = colourStart || vec4.fromValues(0.9, 0.3, 0.3, 1.0);
  this.colour_stop = colourStop || vec4.fromValues(0.6, 0.3, 0.9, 1.0);

  if (colourAmbient === undefined) colourAmbient = 0.7;
  if (colourDiffuse === undefined) colourDiffuse = 0.7;
  if (colourSpecular === undefined) colourSpecular = 0.7;
